...
<?php
	try{
		...
		$sql = "SELECT admin.admin_id, admin.staff_id, admin.name, admin.contact,admin.email, admin.user_id,user.username, user.password 
		FROM admin 
  ...
  <div class="wrapper">
    ...
    <form method="post" class="form">
	  ...
	  <div class="form-group">
	  	...
	  	<div class="relative">
		  <input class="form-control" name="email"  value="<?php echo $result['email']?>" type="email" maxlength="10" oninput="this.value=this.value.replace(/[^0-9]/g,'');" required="" placeholder="Type your Mobile Number...">
	  		<i class="fa fa-phone"></i>
	  	</div>
	  </div>
	...
	<?php
		...
		if (isset($_POST["btnSubmit"])){
			...
			try{
				...
				$query1 = $conn->prepare("UPDATE admin
