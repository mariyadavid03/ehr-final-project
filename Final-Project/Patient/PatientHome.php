    ...
    <!--first row-->
        <div class="row">
            ...
            <div class="col-md-8 py-4 px-4 text-center ">
                    ...
                    <h6 style="margin-left: 20px; margin-top: -4px">200134200675</h6>
                    </div>
                </div>
                <div class="col py-4 px-4">
                    ...
                    <div class="d-flex">
                        <div>
                    <button type="button" class="btn btn-danger btn-sm" style="background-color:red">view</button>
                        </div>
                        <div>
            ...
            <H1 style="color: black;"><b>01/01/2024</b></H1>
            <p>2 Months Until Next Week</p>
            </div>
            </div>
        </div>
...
<!--second row-->
        ...
        <div class="col-md-16 " style="background-color: white; border-radius:18px; box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; height: 100px; margin-left:-12px; margin-right:-12px" id="latestlabres">
                <div class="row py-4 px-4">
                    <H6 style="color: black;"><b>Latest Lab Result:</b></H6>
                    <a href="#"><h6 style="color: black;">
    ...
    <br>
        <div class="col-md-16 " style="background-color: white; border-radius:18px; box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; height: 100px; margin-left:-12px;margin-right:-12px" id="latestlabres">
                <div class="row py-4 px-4">
                    ...
                    <img src="../Images/Icons/document_13530164.png" width="30px">
                    <b>General Visit</b></H6>
                    </a>
                </div>
