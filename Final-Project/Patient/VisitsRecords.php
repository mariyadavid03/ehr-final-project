...
<header class="header" id="header" style="background-color: #F0F1F3; margin-top:-2px;">
    ...
    <div class="container">
    <div class="row" >
        <H2 style="-webkit-text-stroke: 1px black; color:white">Visits Records</H2>
    </div>
...
<br>       
    ...
    function viewAppointment(appointmentId) {
        ...
        window.location.href = 'DoctorNote.php?id=' + appointmentId; // Example: Redirect to a page with the appointment ID in the URL
    }
</script>
