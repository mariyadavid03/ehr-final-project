    ...
    <div class="row">
      <div class="col">
        <div class="mb-3 d-inline-flex">
          ...
          <input type="text" class="form-control mx-2" id="foodInput" placeholder="Enter food name">
          <input type="number" class="form-control" id="amountInput" placeholder="Enter amount (e.g., 1 cup, 2 slices)">
      ...
      <div class="col">
        <div class="mb-3 d-inline-flex">
          ...
          <button type="button" class="btn btn-primary ms-2">ADD</button>
            ...
            <br>
    <div class="container mt-3  " style="margin-left: 59px;;">
    <H1>Category 3 (Natural Risk Patients)</H1>
      <p>NO need Diatary Plan</p>
    </div>
