    ...
    <a href="../Admin .html" class="sidebar-link">
      ...
      <span>Logout</span>
        ...
        <div class="main p-3">
            ...
            <H1>Category 1 (High Risk Patient)</H1>
    <div class="row">
      <div class="col">
        <div class="mb-3 d-inline-flex">
          <input type="text" class="form-control mx-2" id="foodInput" placeholder="Enter Activity">
          <input type="number" class="form-control" id="amountInput" placeholder="Enter Intensity">
          <input type="number" class="form-control" id="amountInput" placeholder="Enter Duration">
          <button type="button" class="btn btn-primary ms-2">ADD</button>
            ...
            <div class="container mt-3  " style="margin-left: 59px;;">
            <H1>Category 2 (Moderate Risk Patient)</H1>
    <div class="row">
      <div class="col">
        <div class="mb-3 d-inline-flex">
          <input type="text" class="form-control mx-2" id="foodInput" placeholder="Enter Activity">
          ...
          <button type="button" class="btn btn-primary ms-2">ADD</button>
            ...
            <br>
            <div class="container mt-3  " style="margin-left: 59px;;">
            <H1>Category 3 (Neutral Risk Patient)</H1>
    <div class="row">
      <div class="col">
        <div class="mb-3 d-inline-flex">
          <input type="text" class="form-control mx-2" id="foodInput" placeholder="Enter Activity">
