    ...
    <br>
        ...
        <div class="col-md-5 mx-auto">
            <div class="input-group">
                <input class="form-control border-end-0 border" type="search" placeholder="Search Patient" id="example-search-input">
                        ...
                        <table id="mytable" class="table table-bordred table-striped">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>01/01/2024</td>
                                    <td>Sugar Test</td>
                                    <td><button type="button" class="btn btn-primary btn-sm">Add Result</button></td>
                                </tr>  
                                <tr>
                                    <td>92829182918</td>
                                    <td>Samiru Geethmal</td>
